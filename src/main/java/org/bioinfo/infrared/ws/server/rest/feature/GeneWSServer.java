...
ENSG00000125835 */
	...
	@GET
	@Path("/list")
	// GeneDBManager: public FeatureList<Gene> getAll() 
...
//	@GET
//	@Path("/{geneId}/info")
//	//public FeatureList<Gene> getAllByBiotype(String biotype) 
//	public Response getAllByBiotype(@PathParam("geneId") String geneId) {
//		if(uriInfo.getQueryParameters().get("biotype") != null) {
